...
export default function WhatsAppButton() {
  ...
  const message = selectedLanguage === 'es' 
    ? "Hola! Me interesa la casa en San Martín de Porres. ¿Podrían darme más información?"
    : "Hello! I'm interested in the house in San Martín de Porres. Could you give me more information?";
